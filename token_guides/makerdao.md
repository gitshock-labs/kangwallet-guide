...
Just like the DAI, the MKR token is an Ethereum based token and can be stored in pretty much any [non-custodial wallet](/fundamentals/2-wallets-basics.md) like Kangaroo, [https://kangwallet.xyz](https://kangwallet.xyz).
